    ...
    <div class="bg-white shadow-lg rounded-lg p-4 h-full flex flex-col relative">
      ...
      <div class="flex flex-col items-center space-y-4 flex-grow w-full">
        <label for="file-upload"
          class="w-full flex flex-col items-center px-4 py-16 bg-gray-100 text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-500 hover:text-white transition duration-300 ease-in-out">
          ...
          <span class="text-xs leading-normal">File must be in PNG format</span>
