  ...
  <div class="max-w-full mx-auto h-full">
    <div class="bg-white shadow-lg rounded-lg p-4 h-full flex flex-col">
      ...
      <div class="flex flex-col items-center space-y-6 flex-grow">
        <label for="file-upload" class="w-full flex flex-col items-center px-4 py-16 bg-gray-100 text-blue rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-500 hover:text-white transition duration-300 ease-in-out"> <!-- py-6 auf py-12 geändert -->
        ...
        <button 
          ...
          <Icon name="mdi:upload" color="white" class="mr-1 text-3xl"/> Upload Dataset
        </button>
      </div>
    </div>
  </div>
