      ...
      <div class="pl-5">
        ...
        <div class="flex items-center">
          <label class="inline-flex items-center mr-4">
            <input type="radio" class="form-radio text-blue-600" name="gridSize" value="3x3" v-model="gridSize">
            <span class="ml-2">3x3 <Icon name="mdi:grid" class="ml-1 w-7 h-7 text-blue-600"/></span>
          </label>
          <label class="inline-flex items-center">
            <input type="radio" class="form-radio text-blue-600" name="gridSize" value="4x4" v-model="gridSize">
